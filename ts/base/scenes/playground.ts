...
const scene_playground = new CoreScene<ScenePlaygroundProps>('Playground', {
    ...
    init_ekg_box() {
        ...
        this.ekg_box_3.init(x, y, w, h, s)
        this.ekg_box_avf.init(x + w, y, w, h, s)
        this.ekg_box_v3.init(x + 2 * w, y, w, h, s)
        this.ekg_box_v6.init(x + 3 * w, y, w, h, s)
        y -= h
        this.ekg_box_2.init(x, y, w, h, s)
        this.ekg_box_avl.init(x + w, y, w, h, s)
        this.ekg_box_v2.init(x + 2 * w, y, w, h, s)
        this.ekg_box_v5.init(x + 3 * w, y, w, h, s)
        y -= h
        this.ekg_box_1.init(x, y, w, h, s)
        this.ekg_box_avr.init(x + w, y, w, h, s)
        this.ekg_box_v1.init(x + 2 * w, y, w, h, s)
        this.ekg_box_v4.init(x + 3 * w, y, w, h, s)
        y -= h
